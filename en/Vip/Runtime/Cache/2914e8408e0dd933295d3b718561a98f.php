...
<div class="accounttitle"><h1>温馨提示 </h1></div>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
              <tr>
                <td width="18%" height="60" align="center" class="zc_hong"><br /><?php echo ($list['Title']); ?></td>
              </tr>
              <tr >
                <td height="30" align="center"><input name="提交" type="submit" class="button_text" onclick="<?php echo ($list['cgs']); ?>location.href='<?php echo ($list['Url']); ?>'" value="确定"></td>
              </tr>
            </table>
</div>
</div>
