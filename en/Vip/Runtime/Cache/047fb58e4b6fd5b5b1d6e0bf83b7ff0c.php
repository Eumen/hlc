		...
		<div class="row center">
			<div class="col-xs-12">
				<button class="btn-lg btn-primary" type="button"
					onclick="javascript:window.location.href='__APP__/Change/changedata'">Profile</button>
			</div>
		</div>
		<br />
		<div class="row center">
			<div class="col-xs-12">
				<button class="btn-lg btn-info" type="button"
					onclick="location.href='__APP__/Change/changepassword'">Changed Password</button>
			</div>
		</div>
		<br />
		<hr>
