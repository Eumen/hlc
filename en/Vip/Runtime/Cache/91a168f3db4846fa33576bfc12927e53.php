...
<div class="accounttitle"><h1>Send Box </h1></div>
<form name="form1" method="post" action="__URL__/f_del/">
<table width="100%" class="tab3" border="0" cellpadding="3" cellspacing="1" id="tb1" bgcolor="#b9c8d0">
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td align="center"><?php if(($vo['f_read']) == "1"): ?><span class="STYLE2" >read</span><?php else: ?><span class="STYLE1" >unread</span><?php endif; ?></td>
    <td align="center"><?php echo (conname($vo['s_user_id'])); ?></td>
    <td align="center"><a href="__URL__/f_view/did/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a></td>
    <td align="center"><?php echo (date('Y-m-d H:i:s',$vo["f_time"])); ?></td>
  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
    <tr>
      <td colspan="5">
      &nbsp;&nbsp;
      <input name="全选" type="button" class="button_text" id="全选" onclick="CheckAll(this.form)" value="all" />
      &nbsp;&nbsp;
